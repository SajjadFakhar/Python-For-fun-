...
# if the objects that we wanna detect, have the same color so the best way is to defined a color filter
# but if the colors are different (without using the DL) we can use moving 
...
cap = cv.VideoCapture("S:/imagedetectionnvideos/Learn_Python_codes-main/Learn_Python_codes-main/Image_processing/Videos/street_camera.mp4")
